...
const messages = defineMessages({
  ...
  "dict.values.freedom.name": {
    id: "dict.values.freedom.name",
    defaultMessage: `Freedom`,
  },
  "dict.values.freedom.description": {
    id: "dict.values.freedom.description",
    defaultMessage: `Freedom is the breath of creativity and innovation. It's about having the space to explore new ideas, express oneself, and make choices that align with one's deepest values and desires. In a setting where freedom is cherished, individuals are empowered to take initiative and drive change, leading to personal growth and collective advancement. Freedom fosters a culture of trust and respect, where constraints are minimized, and possibilities are endless. It encourages a sense of adventure and exploration, allowing people and ideas to flourish. Embracing freedom means embracing diversity and the unique contributions each person brings to the table, creating a vibrant and dynamic environment.`,
  },
});
...
export const useValuesDict = () => {
  ...
  return useMemo(() => valuesDict, [valuesDict]);
};
